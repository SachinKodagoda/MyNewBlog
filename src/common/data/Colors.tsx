...
export const getRest: TGet = {
  light: [
    {
      name: '--xui-shadows-xs',
      color: '0 2px 8px 1px rgb(104 112 118 / 0.07), 0 1px 1px -1px rgb(104 112 118 / 0.04)',
    },
    {
      name: '--xui-shadows-sm',
      color: '0 2px 8px 2px rgb(104 112 118 / 0.07), 0 2px 4px -1px rgb(104 112 118 / 0.04)',
    },
    ...
    {
      name: '--xui-dropShadows-sm',
      color: 'drop-shadow(0 2px 8px rgb(104 112 118 / 0.07)) drop-shadow(0 2px 4px rgb(104 112 118 / 0.04))',
    },
    {
      name: '--xui-dropShadows-md',
      color: 'drop-shadow(0 4px 12px rgb(104 112 118 / 0.08)) drop-shadow(0 20px 8px rgb(104 112 118 / 0.04))',
    },
    {
      name: '--xui-dropShadows-lg',
    ...
    { name: '--xui-primary-sidebar-active-background', color: 'var(--xui-colors-yellow600)' },
    { name: '--xui-primary-sidebar-active-foreground', color: 'var(--xui-colors-black)' },
    { name: '--xui-secondary-sidebar-background', color: 'var(--xui-colors-gray100)' },
    { name: '--xui-secondary-sidebar-foreground', color: 'var(--xui-colors-black)' },
    { name: '--xui-secondary-sidebar-border', color: 'var(--xui-colors-gray300)' },
    { name: '--xui-secondary-sidebar-active-background', color: 'var(--xui-colors-gray900)' },
    { name: '--xui-secondary-sidebar-active-foreground', color: 'var(--xui-colors-white)' },
    { name: '--xui--switchColor', color: 'var(--xui-colors-primary)' },
    { name: '--xui--switchColorShadow', color: 'var(--xui-colors-primaryShadow)' },
    { name: '--xui--switchColorHover', color: 'var(--xui-colors-primarySolidHover)' },
    { name: '--xui--navbarTextColor', color: 'var(--xui-colors-text)' },
  ...
  dark: [
    ...
    { name: '--xui-shadows-sm', color: '0 2px 8px 2px rgb(0 0 0 / 0.07), 0 2px 4px -1px rgb(0 0 0 / 0.04)' },
    ...
    {
      name: '--xui-dropShadows-sm',
      color: 'drop-shadow(0 2px 8px rgb(0 0 0 / 0.07)) drop-shadow(0 2px 4px rgb(0 0 0 / 0.04))',
    },
    {
      name: '--xui-dropShadows-md',
      color: 'drop-shadow(0 4px 12px rgb(0 0 0 / 0.08)) drop-shadow(0 20px 8px rgb(0 0 0 / 0.04))',
    },
    {
      name: '--xui-dropShadows-lg',
