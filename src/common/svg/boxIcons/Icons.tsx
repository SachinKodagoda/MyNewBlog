...
function ChevronDownIcon({ fill, height = 24, size, width = 24, ...props }: ISvg) {
  return (
    <svg
      fill='none'
...
function TagUserIcon({ fill, height = 24, size, width = 24, ...props }: ISvg) {
  return (
    <svg
      fill='none'
      height={size || height}
...
function ServerIcon({ fill, height = 24, size, width = 24, ...props }: ISvg) {
  return (
    <svg
      fill='none'
      height={size || height}
...
function FlashIcon({ fill, height = 24, size, width = 24, ...props }: ISvg) {
  return (
    <svg
      fill='none'
      height={size || height}
...
function ActivityIcon({ fill, height = 24, size, width = 24, ...props }: ISvg) {
  return (
    <svg
...
function ScaleIcon({ fill, height = 24, size, width = 24, ...props }: ISvg) {
  return (
    <svg
      fill='none'
      height={size || height}
